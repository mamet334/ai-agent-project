...
| `PENDING-supabase-security-advisor-findings.md` | ✅ **Selesai Remidiasi RPC** (9 fungsi `SECURITY DEFINER` ditutup/diberi guard per 2026-09-02; Leaked Password via Dashboard) | Supabase RPC Permissions & Security |
