export default {
  name: 'bahasa',
  description: 'Sub-agent untuk memahami nuansa bahasa, menerjemahkan bahasa gaul, idiom, atau menganalisis sentimen dan konteks budaya dalam percakapan. Gunakan jika user (pengguna) menggunakan gaya bahasa khusus, ambigu, atau membutuhkan adaptasi bahasa.',
...
2. Identifikasi makna tersirat atau nuansa khusus dari penulis (pengguna).
